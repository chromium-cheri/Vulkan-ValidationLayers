...
#if defined(__CHERI_PURE_CAPABILITY__)
    vvl::unordered_map<uintptr_t, std::string> debugObjectNameMap;
    vvl::unordered_map<uintptr_t, std::string> debugUtilsObjectNameMap;
#else // defined(__CHERI_PURE_CAPABILITY__)
...
#if defined(__CHERI_PURE_CAPABILITY__)
    std::string DebugReportGetUtilsObjectName(const uintptr_t object) const {
#else // defined(__CHERI_PURE_CAPABILITY__)
...
#if defined(__CHERI_PURE_CAPABILITY__)
    std::string DebugReportGetMarkerObjectName(const uintptr_t object) const {
#else // defined(__CHERI_PURE_CAPABILITY__)
...
#if defined(__CHERI_PURE_CAPABILITY__)
        return FormatHandle(VkHandleInfo<HANDLE_T>::Typename(), HandleToUintPtr(handle));
#else // defined(__CHERI_PURE_CAPABILITY__)
...
#if defined(__CHERI_PURE_CAPABILITY__)
    RemoveDebugUtilsCallback(debug_data, debug_data->debug_callback_list, CastToUintPtr(callback));
#else // defined(__CHERI_PURE_CAPABILITY__)
